...
# Git Commit Numbers {git rev-list --count HEAD}
Name:           warzone2100
Version:        4.4.2
Release:        1_{{{git_commit_no}}}%{?dist}
...
%cmake -DWZ_DISTRIBUTOR=Fedora \
      ...
      -DWZ_INCLUDE_TERRAIN_HIGH_HQ=TRUE \
      -DWZ_DOWNLOAD_PREBUILT_PACKAGES_ASSET_DIR=data/terrain_overrides \
      -DWZ_BUILTIN_MODS_RECLAMATION=ON \
      -DWZ_BUILTIN_MODS_FRACTUREDKINGDOM=ON
...
%changelog
* Sun Jun 23 2024 DrBenson <Benson.Dr@GMail.com> - 4.4.2-1
- Update high.wz: High-Quality 2048x2048 textures, 512x512 decals
- Add Mods translate strings.

* Mon May 20 2024 DrBenson <Benson.Dr@GMail.com> - 4.4.2-0
